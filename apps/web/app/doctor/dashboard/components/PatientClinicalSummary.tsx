...
function PatientInfoCard({ label, value }: { label: string; value: string }) { return <div className="rounded-xl bg-white/[.08] p-3"><p className="text-[11px] font-medium leading-4 text-white/95">{value}</p><p className="mt-1 text-[9px] uppercase tracking-[.1em] text-white/45">{label}</p></div>; }
