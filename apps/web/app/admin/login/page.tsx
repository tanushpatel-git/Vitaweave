    ...
    <main className="min-h-screen overflow-hidden bg-[#f7f9f8] text-[#17201d]">
      <div className="relative min-h-screen">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute -left-32 -top-32 h-[520px] w-[520px] rounded-full bg-[#ece2de] blur-[110px]" />
          <div className="absolute -bottom-40 -right-20 h-[520px] w-[520px] rounded-full bg-[#e2e8ee] blur-[120px]" />
          <div
        ...
        <header className="relative z-20 flex items-center justify-between px-6 py-6 sm:px-10 lg:px-14">
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => router.push("/")} className="flex items-center gap-3">
              ...
              <div>
                <div className="text-[15px] font-semibold tracking-[-0.02em]">VITAWEAVE</div>
          ...
          <div className="grid w-full grid-cols-1 items-center gap-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20">
            ...
            >
              <div className="mb-8 flex items-center gap-3">
                ...
                <span className="text-[10px] font-medium uppercase tracking-[0.24em] text-[#737e79]">
                  Level 1 · Official Access
                </span>
              </div>
              <h1 className="max-w-[720px] text-[clamp(3.5rem,7vw,7.2rem)] font-medium leading-[0.88] tracking-[-0.075em] text-[#17201d]">
                Platform
                <br />
                <span className="text-[#68736f]">control.</span>
                <br />
                One seat.
              </h1>
              <p className="mt-8 max-w-[520px] text-base leading-7 text-[#69736f] sm:text-lg">
                The website administration console manages hospitals, hospital
                administrators, and platform-wide settings — separate from any
                individual hospital workspace.
              </p>
              <div className="mt-12 max-w-[570px]">
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <span className="font-mono text-[9px] text-[#a0aaa6]">GLOBAL / 01</span>
                </div>
                <div className="flex flex-wrap items-center gap-2">
                  {["HOSPITALS", "ADMINS", "USERS", "AUDIT"].map((item, index) => (
                    <div key={item} className="flex items-center gap-2">
                      ...
                      {index < 3 && <ArrowRight size={11} strokeWidth={1.5} className="text-[#a6afab]" />}
                    </div>
                  ))}
                </div>
              </div>
            ...
            >
              ...
              <div className="rounded-[30px] border border-[#dfe5e2] bg-white/78 p-7 shadow-[0_30px_100px_rgba(23,32,29,0.08)] backdrop-blur-2xl sm:p-9">
                <div className="mb-9">
                  <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-2xl bg-[#f3eee9] text-[#6b4a34]">
                  ...
                  <p className="mt-2 text-sm leading-6 text-[#7b8581]">
                    Sign in to manage hospitals and their administrators.
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label htmlFor="admin-email" className="mb-2.5 block text-[9px] font-semibold uppercase tracking-[0.18em] text-[#69736f]">
                      Administrator email
                    </label>
                    <div className="group relative">
                      <Mail size={16} strokeWidth={1.7} className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-[#9aa49f]" />
                      <input
                        id="admin-email"
                        type="email"
                        value={email}
                        onChange={(event) => setEmail(event.target.value)}
                        placeholder="admin@medchat.dev"
                        autoComplete="email"
                        required
                  ...
                  <div>
                    <div className="mb-2.5 flex items-center justify-between">
                      <label htmlFor="admin-password" className="text-[9px] font-semibold uppercase tracking-[0.18em] text-[#69736f]">
                        Password
                      </label>
                    </div>
                    <div className="group relative">
                      <LockKeyhole size={16} strokeWidth={1.7} className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-[#9aa49f]" />
                      <input
                        id="admin-password"
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="group relative mt-2 flex h-14 w-full items-center justify-center gap-3 overflow-hidden rounded-2xl bg-[#17201d] text-sm font-medium text-white shadow-[0_12px_30px_rgba(23,32,29,0.16)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#26332e] active:translate-y-0"
                  >
                    <span>{loading ? "Signing in…" : "Enter platform console"}</span>
                    <ArrowRight size={16} strokeWidth={1.8} />
                  </button>
                </form>

                <div className="mt-7 flex items-center justify-center gap-2 text-center">
                  <ShieldCheck size={14} strokeWidth={1.7} className="text-emerald-600" />
                  <span className="text-[9px] leading-4 text-[#89938f]">
                    Platform-level credentials only · Separate from hospital logins
                  </span>
                </div>
              </div>
              ...
              <p className="mt-6 text-center text-xs text-[#89938f]">
                ...
                >
                  Use the hospital workspace login
                </Link>
              </p>
              <p className="mt-3 flex items-center justify-center gap-1.5 text-[10px] text-[#a0aaa6]">
                <Home size={11} />
                <Link href="/" className="underline decoration-[#c5ceca] underline-offset-4 hover:text-[#17201d]">
                  Back to home
                </Link>
              </p>
            </motion.div>
        ...
        <div className="pointer-events-none absolute bottom-6 left-6 hidden font-mono text-[8px] uppercase tracking-[0.18em] text-[#a0aaa6] sm:left-10 lg:left-14 lg:block">
          VITAWEAVE / PLATFORM ADMINISTRATION / AUTH
        </div>
